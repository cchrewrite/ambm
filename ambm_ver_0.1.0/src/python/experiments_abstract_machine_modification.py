...
for tm in xrange(10):
    ...
    for fn in FL:
        ...
        for sem_mdl_type in ["RF","BNB","LR","SVM","Silas"]:
            ...
            cmd_list.append("python src/python/abstract_machine_batch_modification.py %s/faulty_model/result.mch NEW %s/faulty_model/answer.txt %s %s/repaired_model/"%(mdldir,mdldir,conffile,mdldir))
